...
@Component({
  selector: 'app-smarket-doacao',
  templateUrl: './smarket-doacao.component.html',
  styleUrls: ['./smarket-doacao.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class SmarketDoacaoComponent implements OnInit {

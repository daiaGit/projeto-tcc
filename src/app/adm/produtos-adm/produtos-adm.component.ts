...
import { User, UserProfile, UserWork, UserContacts, UserSocial, UserSettings } from './produtos-adm.model';
...
@Component({
  ...
  providers: [ ProdutosAdmService, MenuService ]
})
export class ProdutosAdmComponent implements OnInit {
  ...
  constructor(public fb:FormBuilder, 
              ...
              public produtosAdmService:ProdutosAdmService,
  ...
  public getUsers(): void {
    this.produtosAdmService.getUsers().subscribe( users => 
      this.users = users
    );    
  }

  public addUser(user:User){
    this.produtosAdmService.addUser(user).subscribe(user => {
      this.getUsers();      
    });
  }

  public updateUser(user:User){
    this.produtosAdmService.updateUser(user).subscribe(user => {
      this.getUsers();      
    });
  }

  public deleteUser(user:User){
    this.produtosAdmService.deleteUser(user.id).subscribe(result => 
      this.getUsers()
    );
  }

...
import { User, UserProfile, UserWork, UserContacts, UserSocial, UserSettings } from './funcionarios-adm.model';
import { FuncionariosAdmService } from './funcionarios-adm.service';
...
@Component({
  ...
  providers: [ FuncionariosAdmService, MenuService ]
})
export class FuncionariosAdmComponent implements OnInit {
  ...
  constructor(public fb:FormBuilder, 
              ...
              public funcionariosAdmService:FuncionariosAdmService,

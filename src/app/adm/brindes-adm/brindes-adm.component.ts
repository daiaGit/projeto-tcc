...
import { User, UserProfile, UserWork, UserContacts, UserSocial, UserSettings } from './brindes-adm.model';
import { BrindesAdmService } from './brindes-adm.service';
import { MenuService } from '../../theme/components/menu/menu.service';
 
@Component({
  selector: 'app-brindes-adm',
  templateUrl: './brindes-adm.component.html',
  styleUrls: ['./brindes-adm.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ BrindesAdmService, MenuService ]
})
export class BrindesAdmComponent implements OnInit {
  ...
  constructor(public fb:FormBuilder, 
              ...
              public brindesAdmService:BrindesAdmService,
  ...
  public getUsers(): void {
    this.brindesAdmService.getUsers().subscribe( users => 
      this.users = users
    );    
  }

  public addUser(user:User){
    this.brindesAdmService.addUser(user).subscribe(user => {
      this.getUsers();      
    });
  }

  public updateUser(user:User){
    this.brindesAdmService.updateUser(user).subscribe(user => {
      this.getUsers();      
    });
  }

  public deleteUser(user:User){
    this.brindesAdmService.deleteUser(user.id).subscribe(result => 
      this.getUsers()
    );
  }

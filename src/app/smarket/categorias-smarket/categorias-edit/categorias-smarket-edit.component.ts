...
@Component({
  selector: 'app-categorias-smarket-edit',
  templateUrl: './categorias-smarket-edit.component.html',
  styleUrls: ['./categorias-smarket-edit.component.scss'],
  providers: [
    TipoTelefoneService,
    CargoService
  ],
...
export class CategoriasSmarketEditComponent implements OnInit {
